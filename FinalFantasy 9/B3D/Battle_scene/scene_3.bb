...
f=ReadFile(GetPathName()) ; File from 6 dir
...
For i=0 To (kol-1)
	...
	For j=0 To 255
		mass[j]=0
		ktmp=0
		ktmp=GetTim(0,0,((tmmp Shr 16) And $3F)*16*2+j*2,(tmmp Shr 16) Shr 6)
		ktmp=ktmp Or (GetTim(0,0,((tmmp Shr 16) And $3F)*16*2+j*2+1,(tmmp Shr 16) Shr 6 ) Shl 8)
